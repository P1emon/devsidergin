...
namespace MyEStore.Migrations
{
    ...
    [Migration("20250502190551_CreateThongBaoTable")]
    partial class CreateThongBaoTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyEStore.Entities.HangHoaChiTiet", b =>
                {
                    ...
                    b.Property<string>("CongNgheDacBiet")
                        .IsRequired()
                        .HasMaxLength(1000)
                    ...
                    b.Property<string>("LoiIchNoiBat")
                        .IsRequired()
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("MyEStore.Entities.KhachHang", b =>
                {
                    ...
                    b.Property<DateTime?>("DangNhapLanCuoi")
                        .HasColumnType("datetime2");

                    b.Property<string>("DiaChi")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DiaChiPhu")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("MuaHangLanCuoi")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("MyEStore.Entities.Rank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MucDiemDen")
                        .HasColumnType("int");

                    b.Property<int>("MucDiemTu")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyEStore.Models.Slider", b =>
                {
                    ...
                    b.Property<string>("LinkQuangCao")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("MyEStore.Entities.HangHoaChiTiet", b =>
                {
                    b.HasOne("MyEStore.Entities.HangHoa", "HangHoa")
                        .WithOne("HangHoaChiTiet")
                        .HasForeignKey("MyEStore.Entities.HangHoaChiTiet", "MaHh")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
